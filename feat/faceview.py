...
audict = {'AU1' : {19:(2,0),24:(-2,0),20:(5,-8),23:(-5,-8),21:(0,-20),22:(0,-20) },
# Brow Lowerer
'AU4': {18:(4,5),25:(-4,5),19:(4,15),24:(-4,15),20:(5,20),23:(-5,20),21:(0,15),22:(0,15) },

# Upper Lid Raiser
'AU5': {17:(2,-9),26:(2,-9), 18:(2,-10),25:(-2,-10),19:(2,-15),24:(-2,-15),
        20:(5,-12),23:(-5,-12), 21:(0,-10),22:(0,-10),
          37:(0,-10),38:(0,-10),44:(0,-10),43:(0,-10),
          40:(0,10),41:(0,10),47:(0,10),46:(0,10)}  ,
# cheek raiser
'AU6': {0:(20,0),16:(-20,0), 1:(10,-5),15:(-10,-5), 2:(2,-8), 14:(-2,-8),
       17:(5,5),26:(-5,5),
      45:(-5,5),46:(-3,-3),47:(-3,-3),
      36:(5,5),41:(3,-3),40:(3,-3)},
# nose wrinkler
'AU9': {38:(2,4),43:(-2,4),39:(2,3),42:(-2,3),
        27:(0,5), 28:(0,-5), 29:(0,-7), 30:(0,-10),
       31:(5,-15),32:(0,-15),33:(0,-15),34:(0,-15),35:(-5,-15),
      18:(2,0),25:(-2,0),19:(2,8),24:(-2,8),20:(5,12),23:(-5,12),21:(0,10),22:(0,10)
                  },
# Lip corner Puller
'AU12': { 48: (-10,-15), 49: (-5,-5),
          54:(10,-15), 53:(5,-5)},
# Chin raiser
'AU17': { 6:(5,0),7:(5,-5),8:(0,-20),9:(-5,-5),10:(-5,0) },
# Lip Puckerer
'AU18': {48:(5,0), 54:(-5,0), 49:(5,0), 34:(-5,0),
        59:(5,0),55:(-5,0), 51:(0,-8),57:(0,10),58:(0,7),56:(0,7)} ,
# Lips Part
'AU25': {50:(0,-3),52:(0,-3),51:(0,-5),57:(0,7),58:(0,7),56:(0,7)}}
    ...
    def change(self, aus = [], weights = 1, baseface=neutralface):
        ...
        for au in aulist:
            for landmark in audict[au].keys():
                newface[landmark] = (self[landmark][0] + au_weights[au] * audict[au][landmark][0],
                                    self[landmark][1] + au_weights[au] *  audict[au][landmark][1])
        return newface
